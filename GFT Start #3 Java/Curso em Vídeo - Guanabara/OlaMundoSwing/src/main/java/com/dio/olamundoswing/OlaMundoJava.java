...
public class OlaMundoJava extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblMensagem.setFont(new java.awt.Font("Garuda", 3, 24)); // NOI18N
        lblMensagem.setForeground(new java.awt.Color(255, 0, 109));
        lblMensagem.setText("Aqui vai aparecer a mensagem");

        btnCLick.setLabel("Aperte aqui!");
